...
public class BondCapitalIndexedSecurityDiscountingMethodTest {
  ...
  private static final Currency USD = PRICE_INDEX_USCPI.getCurrency();
  private static final Currency GBP = PRICE_INDEX_UKRPI.getCurrency();
  ...
  public void presentValueGilt1() {
    ...
    assertEquals("Inflation Capital Indexed bond: present value", pvExpectd.getAmount(GBP), pv.getAmount(GBP), 1.0E-2);
  }
  ...
  public void presentValueTips1() {
    ...
    assertEquals("Inflation Capital Indexed bond: present value", pvExpectd.getAmount(USD), pv.getAmount(USD), 1.0E-2);
  }
